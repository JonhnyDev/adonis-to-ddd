...
var standalone_1 = require("@adonisjs/core/build/standalone"); // ManifestGenerator
var sink_1 = require("@adonisjs/sink");
var DDDConfig = /** @class */ (function (_super) {
    __extends(DDDConfig, _super);
    function DDDConfig() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    DDDConfig.prototype.run = function () {
    ...
    DDDConfig.commandName = 'ddd:config';
    DDDConfig.description = 'edit the .adonisrc.json configuration file to follow the DDD pattern';
    return DDDConfig;
}(standalone_1.BaseCommand));
exports.default = DDDConfig;
